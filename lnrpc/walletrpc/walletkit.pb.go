...
type SubmitPackageRequest struct {
	...
	ParentTxs [][]byte `protobuf:"bytes,1,rep,name=parent_txs,json=parentTxs,proto3" json:"parent_txs,omitempty"`
	...
	// the entire package.
	ChildTx []byte `protobuf:"bytes,2,opt,name=child_tx,json=childTx,proto3" json:"child_tx,omitempty"`
	...
	MaxFeeRateSatPerKw uint32 `protobuf:"varint,3,opt,name=max_fee_rate_sat_per_kw,json=maxFeeRateSatPerKw,proto3" json:"max_fee_rate_sat_per_kw,omitempty"`
}
...
func (x *SubmitPackageRequest) GetParentTxs() [][]byte {
	if x != nil {
		return x.ParentTxs
	}
	return nil
...
func (x *SubmitPackageRequest) GetChildTx() []byte {
	if x != nil {
		return x.ChildTx
	}
	return nil
...
func (x *SubmitPackageRequest) GetMaxFeeRateSatPerKw() uint32 {
	if x != nil {
...
type SubmitPackageResponse struct {
	...
	// A list of hex-encoded transaction IDs of all transactions from the
	// submitted package (parents and child) that were successfully accepted
	// into the backend node's mempool or were already present.
	PackageTxids []string `protobuf:"bytes,1,rep,name=package_txids,json=packageTxids,proto3" json:"package_txids,omitempty"`
}
...
func (x *SubmitPackageResponse) GetPackageTxids() []string {
	if x != nil {
		return x.PackageTxids
	}
	return nil
}
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x10, 0x01, 0x32, 0xaa, 0x12, 0x0a, 0x09, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x4b, 0x69,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5e, 0x0a, 0x11, 0x42, 0x75, 0x6d,
	0x70, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x46, 0x65, 0x65, 0x12, 0x23,
	0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x42, 0x75, 0x6d, 0x70, 0x46,
	0x6f, 0x72, 0x63, 0x65, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x46, 0x65, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65,
	0x50, 0x73, 0x62, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x52, 0x0a, 0x0d,
	0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x12, 0x1f, 0x2e,
	0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74,
	0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20,
	0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x69,
...
var file_walletrpc_walletkit_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_walletrpc_walletkit_proto_goTypes = []interface{}{
	...
	(*SubmitPackageRequest)(nil),              // 64: walletrpc.SubmitPackageRequest
	(*SubmitPackageResponse)(nil),             // 65: walletrpc.SubmitPackageResponse
	(*ListSweepsResponse_TransactionIDs)(nil), // 66: walletrpc.ListSweepsResponse.TransactionIDs
	nil,                              // 67: walletrpc.TxTemplate.OutputsEntry
	(*lnrpc.Utxo)(nil),               // 68: lnrpc.Utxo
	(*lnrpc.OutPoint)(nil),           // 69: lnrpc.OutPoint
	(*signrpc.TxOut)(nil),            // 70: signrpc.TxOut
	(lnrpc.CoinSelectionStrategy)(0), // 71: lnrpc.CoinSelectionStrategy
	(*lnrpc.ChannelPoint)(nil),       // 72: lnrpc.ChannelPoint
	(*lnrpc.TransactionDetails)(nil), // 73: lnrpc.TransactionDetails
	(*signrpc.KeyLocator)(nil),       // 74: signrpc.KeyLocator
	(*signrpc.KeyDescriptor)(nil),    // 75: signrpc.KeyDescriptor
	(*lnrpc.Transaction)(nil),        // 76: lnrpc.Transaction
}
var file_walletrpc_walletkit_proto_depIdxs = []int32{
	68, // 0: walletrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	69, // 1: walletrpc.LeaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	69, // 2: walletrpc.ReleaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	...
	70, // 17: walletrpc.SendOutputsRequest.outputs:type_name -> signrpc.TxOut
	71, // 18: walletrpc.SendOutputsRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	69, // 19: walletrpc.PendingSweep.outpoint:type_name -> lnrpc.OutPoint
	...
	69, // 22: walletrpc.BumpFeeRequest.outpoint:type_name -> lnrpc.OutPoint
	72, // 23: walletrpc.BumpForceCloseFeeRequest.chan_point:type_name -> lnrpc.ChannelPoint
	73, // 24: walletrpc.ListSweepsResponse.transaction_details:type_name -> lnrpc.TransactionDetails
	66, // 25: walletrpc.ListSweepsResponse.transaction_ids:type_name -> walletrpc.ListSweepsResponse.TransactionIDs
	...
	71, // 29: walletrpc.FundPsbtRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	57, // 30: walletrpc.FundPsbtResponse.locked_utxos:type_name -> walletrpc.UtxoLease
	69, // 31: walletrpc.TxTemplate.inputs:type_name -> lnrpc.OutPoint
	67, // 32: walletrpc.TxTemplate.outputs:type_name -> walletrpc.TxTemplate.OutputsEntry
	69, // 33: walletrpc.UtxoLease.outpoint:type_name -> lnrpc.OutPoint
	...
	74, // 40: walletrpc.WalletKit.DeriveKey:input_type -> signrpc.KeyLocator
	...
	64, // 63: walletrpc.WalletKit.SubmitPackage:input_type -> walletrpc.SubmitPackageRequest
	4,  // 64: walletrpc.WalletKit.ListUnspent:output_type -> walletrpc.ListUnspentResponse
	6,  // 65: walletrpc.WalletKit.LeaseOutput:output_type -> walletrpc.LeaseOutputResponse
	8,  // 66: walletrpc.WalletKit.ReleaseOutput:output_type -> walletrpc.ReleaseOutputResponse
	63, // 67: walletrpc.WalletKit.ListLeases:output_type -> walletrpc.ListLeasesResponse
	75, // 68: walletrpc.WalletKit.DeriveNextKey:output_type -> signrpc.KeyDescriptor
	75, // 69: walletrpc.WalletKit.DeriveKey:output_type -> signrpc.KeyDescriptor
	11, // 70: walletrpc.WalletKit.NextAddr:output_type -> walletrpc.AddrResponse
	76, // 71: walletrpc.WalletKit.GetTransaction:output_type -> lnrpc.Transaction
	16, // 72: walletrpc.WalletKit.ListAccounts:output_type -> walletrpc.ListAccountsResponse
	18, // 73: walletrpc.WalletKit.RequiredReserve:output_type -> walletrpc.RequiredReserveResponse
	20, // 74: walletrpc.WalletKit.ListAddresses:output_type -> walletrpc.ListAddressesResponse
	23, // 75: walletrpc.WalletKit.SignMessageWithAddr:output_type -> walletrpc.SignMessageWithAddrResponse
	25, // 76: walletrpc.WalletKit.VerifyMessageWithAddr:output_type -> walletrpc.VerifyMessageWithAddrResponse
	27, // 77: walletrpc.WalletKit.ImportAccount:output_type -> walletrpc.ImportAccountResponse
	29, // 78: walletrpc.WalletKit.ImportPublicKey:output_type -> walletrpc.ImportPublicKeyResponse
	34, // 79: walletrpc.WalletKit.ImportTapscript:output_type -> walletrpc.ImportTapscriptResponse
	36, // 80: walletrpc.WalletKit.PublishTransaction:output_type -> walletrpc.PublishResponse
	37, // 81: walletrpc.WalletKit.RemoveTransaction:output_type -> walletrpc.RemoveTransactionResponse
	39, // 82: walletrpc.WalletKit.SendOutputs:output_type -> walletrpc.SendOutputsResponse
	41, // 83: walletrpc.WalletKit.EstimateFee:output_type -> walletrpc.EstimateFeeResponse
	44, // 84: walletrpc.WalletKit.PendingSweeps:output_type -> walletrpc.PendingSweepsResponse
	46, // 85: walletrpc.WalletKit.BumpFee:output_type -> walletrpc.BumpFeeResponse
	48, // 86: walletrpc.WalletKit.BumpForceCloseFee:output_type -> walletrpc.BumpForceCloseFeeResponse
	50, // 87: walletrpc.WalletKit.ListSweeps:output_type -> walletrpc.ListSweepsResponse
	52, // 88: walletrpc.WalletKit.LabelTransaction:output_type -> walletrpc.LabelTransactionResponse
	54, // 89: walletrpc.WalletKit.FundPsbt:output_type -> walletrpc.FundPsbtResponse
	59, // 90: walletrpc.WalletKit.SignPsbt:output_type -> walletrpc.SignPsbtResponse
	61, // 91: walletrpc.WalletKit.FinalizePsbt:output_type -> walletrpc.FinalizePsbtResponse
	65, // 92: walletrpc.WalletKit.SubmitPackage:output_type -> walletrpc.SubmitPackageResponse
...
func file_walletrpc_walletkit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_walletrpc_walletkit_proto_msgTypes[61].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubmitPackageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_walletrpc_walletkit_proto_msgTypes[62].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubmitPackageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
