...
import (
	...
	api "github.com/lightningnetwork/lnd/lnrpc/api"
...
func (Failure_FailureCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7214bc1619ffe283, []int{7, 0}
}
...
type SendPaymentRequest struct {
	...
	RouteHints []*api.RouteHint `protobuf:"bytes,10,rep,name=route_hints,proto3" json:"route_hints,omitempty"`
	//*
	...
	//fallback.
	DestFeatures         []api.FeatureBit `protobuf:"varint,16,rep,packed,name=dest_features,json=destFeatures,proto3,enum=lnrpc.FeatureBit" json:"dest_features,omitempty"`
...
func (m *SendPaymentRequest) GetRouteHints() []*api.RouteHint {
	if m != nil {
		return m.RouteHints
	}
	return nil
...
func (m *SendPaymentRequest) GetDestFeatures() []api.FeatureBit {
	if m != nil {
...
type PaymentStatus struct {
	...
	State PaymentState `protobuf:"varint,1,opt,name=state,proto3,enum=router.PaymentState" json:"state,omitempty"`
	//*
	//The pre-image of the payment when state is SUCCEEDED.
	Preimage []byte `protobuf:"bytes,2,opt,name=preimage,proto3" json:"preimage,omitempty"`
	//*
	//The taken route when state is SUCCEEDED.
	Route *api.Route `protobuf:"bytes,3,opt,name=route,proto3" json:"route,omitempty"`
	//*
	//The HTLCs made in attempt to settle the payment [EXPERIMENTAL].
	Htlcs                []*api.HTLCAttempt `protobuf:"bytes,4,rep,name=htlcs,proto3" json:"htlcs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *PaymentStatus) GetRoute() *api.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
func (m *PaymentStatus) GetHtlcs() []*api.HTLCAttempt {
	if m != nil {
		return m.Htlcs
	}
	return nil
...
func (m *SendToRouteRequest) GetRoute() *api.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
type Failure struct {
	...
	Code Failure_FailureCode `protobuf:"varint,1,opt,name=code,proto3,enum=router.Failure_FailureCode" json:"code,omitempty"`
...
func (m *BuildRouteResponse) GetRoute() *api.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
func init() {
	proto.RegisterEnum("router.PaymentState", PaymentState_name, PaymentState_value)
	proto.RegisterEnum("router.Failure_FailureCode", Failure_FailureCode_name, Failure_FailureCode_value)
	proto.RegisterType((*SendPaymentRequest)(nil), "router.SendPaymentRequest")
	proto.RegisterMapType((map[uint64][]byte)(nil), "router.SendPaymentRequest.DestCustomRecordsEntry")
	proto.RegisterType((*TrackPaymentRequest)(nil), "router.TrackPaymentRequest")
	proto.RegisterType((*PaymentStatus)(nil), "router.PaymentStatus")
	proto.RegisterType((*RouteFeeRequest)(nil), "router.RouteFeeRequest")
	proto.RegisterType((*RouteFeeResponse)(nil), "router.RouteFeeResponse")
	proto.RegisterType((*SendToRouteRequest)(nil), "router.SendToRouteRequest")
	proto.RegisterType((*SendToRouteResponse)(nil), "router.SendToRouteResponse")
	proto.RegisterType((*Failure)(nil), "router.Failure")
	proto.RegisterType((*ChannelUpdate)(nil), "router.ChannelUpdate")
	proto.RegisterType((*ResetMissionControlRequest)(nil), "router.ResetMissionControlRequest")
	proto.RegisterType((*ResetMissionControlResponse)(nil), "router.ResetMissionControlResponse")
	proto.RegisterType((*QueryMissionControlRequest)(nil), "router.QueryMissionControlRequest")
	proto.RegisterType((*QueryMissionControlResponse)(nil), "router.QueryMissionControlResponse")
	proto.RegisterType((*PairHistory)(nil), "router.PairHistory")
	proto.RegisterType((*PairData)(nil), "router.PairData")
	proto.RegisterType((*QueryProbabilityRequest)(nil), "router.QueryProbabilityRequest")
	proto.RegisterType((*QueryProbabilityResponse)(nil), "router.QueryProbabilityResponse")
	proto.RegisterType((*BuildRouteRequest)(nil), "router.BuildRouteRequest")
	proto.RegisterType((*BuildRouteResponse)(nil), "router.BuildRouteResponse")
}
...
var fileDescriptor_7214bc1619ffe283 = []byte{
	...
	,
}
...
func (c *routerClient) SendPayment(ctx context.Context, in *SendPaymentRequest, opts ...grpc.CallOption) (Router_SendPaymentClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Router_serviceDesc.Streams[0], "/router.Router/SendPayment", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) TrackPayment(ctx context.Context, in *TrackPaymentRequest, opts ...grpc.CallOption) (Router_TrackPaymentClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Router_serviceDesc.Streams[1], "/router.Router/TrackPayment", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routerClient) EstimateRouteFee(ctx context.Context, in *RouteFeeRequest, opts ...grpc.CallOption) (*RouteFeeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/router.Router/EstimateRouteFee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) SendToRoute(ctx context.Context, in *SendToRouteRequest, opts ...grpc.CallOption) (*SendToRouteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/router.Router/SendToRoute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) ResetMissionControl(ctx context.Context, in *ResetMissionControlRequest, opts ...grpc.CallOption) (*ResetMissionControlResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/router.Router/ResetMissionControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) QueryMissionControl(ctx context.Context, in *QueryMissionControlRequest, opts ...grpc.CallOption) (*QueryMissionControlResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/router.Router/QueryMissionControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) QueryProbability(ctx context.Context, in *QueryProbabilityRequest, opts ...grpc.CallOption) (*QueryProbabilityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/router.Router/QueryProbability", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routerClient) BuildRoute(ctx context.Context, in *BuildRouteRequest, opts ...grpc.CallOption) (*BuildRouteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/router.Router/BuildRoute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Router_EstimateRouteFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/router.Router/EstimateRouteFee",
	}
...
func _Router_SendToRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/router.Router/SendToRoute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_ResetMissionControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/router.Router/ResetMissionControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_QueryMissionControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/router.Router/QueryMissionControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_QueryProbability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/router.Router/QueryProbability",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Router_BuildRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/router.Router/BuildRoute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
