...
// source: invoices/invoices.proto
...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_31990f4ac7dbed92, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_31990f4ac7dbed92, []int{1}
}
...
type AddHoldInvoiceRequest struct {
	...
	RouteHints []*api.RouteHint `protobuf:"bytes,8,rep,name=route_hints,proto3" json:"route_hints,omitempty"`
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_31990f4ac7dbed92, []int{2}
}
...
func (m *AddHoldInvoiceRequest) GetRouteHints() []*api.RouteHint {
	if m != nil {
		return m.RouteHints
	}
	return nil
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_31990f4ac7dbed92, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_31990f4ac7dbed92, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_31990f4ac7dbed92, []int{5}
}
...
func (*SubscribeSingleInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_31990f4ac7dbed92, []int{6}
}
...
func init() {
	proto.RegisterType((*CancelInvoiceMsg)(nil), "invoices.CancelInvoiceMsg")
	proto.RegisterType((*CancelInvoiceResp)(nil), "invoices.CancelInvoiceResp")
	proto.RegisterType((*AddHoldInvoiceRequest)(nil), "invoices.AddHoldInvoiceRequest")
	proto.RegisterType((*AddHoldInvoiceResp)(nil), "invoices.AddHoldInvoiceResp")
	proto.RegisterType((*SettleInvoiceMsg)(nil), "invoices.SettleInvoiceMsg")
	proto.RegisterType((*SettleInvoiceResp)(nil), "invoices.SettleInvoiceResp")
	proto.RegisterType((*SubscribeSingleInvoiceRequest)(nil), "invoices.SubscribeSingleInvoiceRequest")
}

func init() { proto.RegisterFile("invoices/invoices.proto", fileDescriptor_31990f4ac7dbed92) }

var fileDescriptor_31990f4ac7dbed92 = []byte{
	// 500 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *invoicesClient) SubscribeSingleInvoice(ctx context.Context, in *SubscribeSingleInvoiceRequest, opts ...grpc.CallOption) (Invoices_SubscribeSingleInvoiceClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Invoices_serviceDesc.Streams[0], "/invoices.Invoices/SubscribeSingleInvoice", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *invoicesSubscribeSingleInvoiceClient) Recv() (*api.Invoice, error) {
	m := new(api.Invoice)
...
func (c *invoicesClient) CancelInvoice(ctx context.Context, in *CancelInvoiceMsg, opts ...grpc.CallOption) (*CancelInvoiceResp, error) {
	...
	err := c.cc.Invoke(ctx, "/invoices.Invoices/CancelInvoice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicesClient) AddHoldInvoice(ctx context.Context, in *AddHoldInvoiceRequest, opts ...grpc.CallOption) (*AddHoldInvoiceResp, error) {
	...
	err := c.cc.Invoke(ctx, "/invoices.Invoices/AddHoldInvoice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicesClient) SettleInvoice(ctx context.Context, in *SettleInvoiceMsg, opts ...grpc.CallOption) (*SettleInvoiceResp, error) {
	...
	err := c.cc.Invoke(ctx, "/invoices.Invoices/SettleInvoice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (x *invoicesSubscribeSingleInvoiceServer) Send(m *api.Invoice) error {
...
func _Invoices_CancelInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invoices.Invoices/CancelInvoice",
	}
...
func _Invoices_AddHoldInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invoices.Invoices/AddHoldInvoice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Invoices_SettleInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/invoices.Invoices/SettleInvoice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Invoices_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "invoices/invoices.proto",
}
