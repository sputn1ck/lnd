...
var file_lightning_proto_depIdxs = []int32{
	...
	32,  // 59: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	...
	100, // 62: lnrpc.ChannelBalanceResponse.local_balance:type_name -> lnrpc.Amount
	100, // 63: lnrpc.ChannelBalanceResponse.remote_balance:type_name -> lnrpc.Amount
	100, // 64: lnrpc.ChannelBalanceResponse.unsettled_local_balance:type_name -> lnrpc.Amount
	100, // 65: lnrpc.ChannelBalanceResponse.unsettled_remote_balance:type_name -> lnrpc.Amount
	100, // 66: lnrpc.ChannelBalanceResponse.pending_open_local_balance:type_name -> lnrpc.Amount
	100, // 67: lnrpc.ChannelBalanceResponse.pending_open_remote_balance:type_name -> lnrpc.Amount
	26,  // 68: lnrpc.QueryRoutesRequest.fee_limit:type_name -> lnrpc.FeeLimit
	105, // 69: lnrpc.QueryRoutesRequest.ignored_edges:type_name -> lnrpc.EdgeLocator
	104, // 70: lnrpc.QueryRoutesRequest.ignored_pairs:type_name -> lnrpc.NodePair
	199, // 71: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	133, // 72: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	8,   // 73: lnrpc.QueryRoutesRequest.dest_features:type_name -> lnrpc.FeatureBit
	110, // 74: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	108, // 75: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	109, // 76: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	200, // 77: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	107, // 78: lnrpc.Route.hops:type_name -> lnrpc.Hop
	113, // 79: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	116, // 80: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	114, // 81: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	201, // 82: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	115, // 83: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	115, // 84: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	113, // 85: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	116, // 86: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	...
	129, // 89: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	130, // 90: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	131, // 91: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	114, // 92: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	203, // 93: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	32,  // 94: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	115, // 95: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	32,  // 96: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	132, // 97: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	133, // 98: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	14,  // 99: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	135, // 100: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	...
	136, // 104: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	134, // 105: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	15,  // 106: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	143, // 107: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	...
	110, // 110: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	183, // 111: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	142, // 112: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	32,  // 113: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	133, // 114: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	...
	32,  // 117: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	161, // 118: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	32,  // 119: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	32,  // 120: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	32,  // 121: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	...
	92,  // 141: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	97,  // 143: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	154, // 144: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	121, // 145: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	...
	98,  // 150: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	101, // 151: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	24,  // 152: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	35,  // 153: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	39,  // 154: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	41,  // 155: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	24,  // 156: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	37,  // 157: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	43,  // 158: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	45,  // 159: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	47,  // 160: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	49,  // 161: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	51,  // 162: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	64,  // 163: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	66,  // 164: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	68,  // 165: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	70,  // 166: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	93,  // 167: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	56,  // 168: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	95,  // 169: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	60,  // 170: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	80,  // 171: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	80,  // 172: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	90,  // 173: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	31,  // 174: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	76,  // 175: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	148, // 176: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	27,  // 177: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	27,  // 178: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	29,  // 179: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	29,  // 180: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	134, // 181: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	139, // 182: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	138, // 183: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	141, // 184: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	152, // 185: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	144, // 186: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	146, // 187: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	117, // 188: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	119, // 189: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	122, // 190: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	111, // 191: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	103, // 192: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	123, // 193: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	125, // 194: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	127, // 195: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	150, // 196: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	155, // 197: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	158, // 198: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	160, // 199: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	163, // 200: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	166, // 201: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	167, // 202: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	169, // 203: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	171, // 204: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	174, // 205: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	176, // 206: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	178, // 207: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	181, // 208: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	20,  // 209: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	18,  // 210: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	99,  // 211: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	102, // 212: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	25,  // 213: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	36,  // 214: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	40,  // 215: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	42,  // 216: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	23,  // 217: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	38,  // 218: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	44,  // 219: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	46,  // 220: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	48,  // 221: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	50,  // 222: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	52,  // 223: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	65,  // 224: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	67,  // 225: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	69,  // 226: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	71,  // 227: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	94,  // 228: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	57,  // 229: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	96,  // 230: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	61,  // 231: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	32,  // 232: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	81,  // 233: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	91,  // 234: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	30,  // 235: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	77,  // 236: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	149, // 237: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	28,  // 238: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	28,  // 239: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	28,  // 240: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	28,  // 241: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	137, // 242: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	140, // 243: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	134, // 244: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	134, // 245: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	153, // 246: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	145, // 247: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	147, // 248: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	118, // 249: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	120, // 250: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	116, // 251: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	112, // 252: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	106, // 253: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	124, // 254: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	126, // 255: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	128, // 256: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	151, // 257: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	157, // 258: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	159, // 259: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	162, // 260: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	164, // 261: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	167, // 262: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	172, // 263: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	170, // 264: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	167, // 265: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	175, // 266: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	177, // 267: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	179, // 268: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	182, // 269: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	21,  // 270: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	19,  // 271: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
