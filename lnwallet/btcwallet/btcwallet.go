...
//
// Returns:
//   - []*chainhash.Hash: A slice containing the transaction IDs (txids) of all
//     transactions from the submitted package (parents and child) that were
//     successfully accepted into the backend node's mempool or were already
//     present.
...
func (b *BtcWallet) SubmitPackage(parents []*wire.MsgTx, child *wire.MsgTx,
	maxFeeRate chainfee.SatPerKWeight) ([]*chainhash.Hash, error) {
